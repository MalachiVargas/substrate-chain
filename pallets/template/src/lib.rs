...
pub mod pallet {
	...
	// Dispatchable functions must be annotated with a weight and must return a DispatchableResult.
	#[pallet::call]
	impl<T: Config> Pallet<T> {
		...
		pub fn revoke_claim(
			...
			let (owner, _) = Proofs::<T>::get(&proof).expect("All proofs must have been an owner!");
